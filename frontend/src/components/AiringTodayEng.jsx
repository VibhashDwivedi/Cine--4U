...
const AiringTodayEng = () => {
    ...
    const POPULAR = 'https://api.themoviedb.org/3/tv/airing_today?api_key=3b813a8cad6a0e292c66f061d98d42a8&language=en-US&page=1'
        ...
        <div className=" col-lg-2 col-md-2  left">
          <Navbar/>
            ...
            <div className="center col-lg-10 col-md-10 ">
             ...
             <h1 className='text-center m-4'> Airing Today</h1>
